...
def get_box3d_iou(box_info):
    ...
    # Sanity checks with ground truth revealed instability of this method, so replaced by new method from Facebook
    iou_3d, _ = box3d_iou(corners_3d_ground, corners_3d_predict)

    # Using box3D_overlap method from pytorch3d: https://pytorch3d.org/docs/iou3d
